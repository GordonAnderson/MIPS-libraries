...
/*!
    ...
    v1.0 - First release
    v1.2  - Added the wire1 support for due and getStatus function - GAA
*/
/**************************************************************************/
#if ARDUINO >= 100
 #include "Arduino.h"
...
// Added by GAA to use on MIPS with wire1 port
#if defined(__SAM3X8E__)
TwoWire *wireADS1015 = &Wire1;   // Use second TWI channel on the DUE
#define Wire (*wireADS1015)
#endif
...
/**************************************************************************/
/*!
    @brief  Gets the last status value from the wire endtransmission
*/
/**************************************************************************/
uint8_t Adafruit_ADS1015::getStatus()
{
  return status;
}
